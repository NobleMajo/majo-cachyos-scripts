...
- `alldown`: Same as `allup` but shuts down afterwards.  
  ...
  _On the way to bed you can execute this and leave your computer alone._
- `allre`: Same as `allup` but triggers a restart via the desktop environment.  
  ...
  _For the time of execution and until the system is started again you can go to the toilet or chill on your phone._
...
2. Then configure your shell’s config file with convenient aliases:
   ...
   ```bash
   MAJO_SCRIPT_DIR="$HOME/ws/tools/majo-cachyos-scripts"
